...
const TravelForm = () => {
  ...
  return (
    <>
      {submitted && <Navigate replace to="/results" />}
      <Formik
        initialValues={{
      ...
      >
        {({
          ...
          <Card sx={{ width: `min(90%, 30rem)`, display: `flex` }}>
            <CardContent>
                ...
                <Grid container rowSpacing={2} columnSpacing={1}>
                  ...
                  <Grid item xs={12}>
                    <Field
                      ...
                      name="intermediate"
                      label="Intermediate"
                      // defaultValue={initialValues.intermediate}
                      fullWidth
                      error={errors.intermediate ? true : false}
                      helperText={
                        errors.intermediate ? errors.intermediate : ""
                      }
                    />
                  </Grid>
                  <Button
